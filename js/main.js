 ...
 * 
 * Почему не добавляем outline через JS:
 * - CSS :focus-visible автоматически определяет способ фокуса
 * - JS-добавление outline ломает дизайн при клике мышью
 * - Современные браузеры отлично поддерживают :focus-visible
 * 
 * Подробнее: https://developer.mozilla.org/ru/docs/Web/CSS/:focus-visible
 */
